...
traces/ is used for normal ChampSim/DPC-style traces.

traces_crc2/ is used for CRC-2 traces, which are kept separate because they are specifically used for cache replacement policy experiments.
